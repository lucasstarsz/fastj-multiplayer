...
public class ExtraMaths {
    ...
    /**
     * Scales the provided number {@code num} on a scale of {@code} to {@code 1} based on the provided {@code minimum}
     * and {@code maximum} values.
     *
    ...
    /**
     * Scales the provided number {@code num} on a scale of {@code 0.0} to {@code 1.0} based on the provided
     * {@code minimum} and {@code maximum} values.
     *
     * @param num The number to normalize.
     * @param min The minimum value in a range of possible values for {@code num}.
     * @param max The maximum value in a range of possible values for {@code num}.
